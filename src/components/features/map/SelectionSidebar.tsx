    ...
    <AnimatePresence>
      {selectedBuildingIds.length > 0 ? (
        <motion.div
          ...
          className="absolute right-0 top-0 z-10 flex h-full w-72 flex-col border-l border-border bg-background/95 backdrop-blur-sm"
        >
              ...
              {selectedBuildings.map((building) => (
                ...
                >
                  <span
                    ...
                    style={{
                      backgroundColor: getArchitectColor(
                        building.architectId
                      ),
                    }}
                  />
